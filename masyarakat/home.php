		...
		<div class="col-md-12" mt-3>
			...
			<div class="card">
				...
				<div class="card-body">
					<form action=""  method="POST" enctype="multipart/form-data">				
						...
						<div class="mb-3">
							...
							<input type="file" clas="form-control" name="foto" required>		
						</div>								
					</div>
				...
				if (isset($_POST['kirim'])) {
					...
					$query = mysqli_query($koneksi, "INSERT INTO pengaduan VALUES ('','$tanggal','$nik','$judul_laporan','$isi_laporan','$status','$nama_foto')");
											...
											<div class="modal-dialog">
												<div class="modal-content">
													...
													<div class="modal-body">
														Apakah anda yakin akan menghapus <br> <?php echo $data['judul_laporan'] ?>
													</div>
